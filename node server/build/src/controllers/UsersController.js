...
var UsersController = /** @class */ (function (_super) {
    ...
    UsersController.prototype.registerController = function (application) {
        application.get("/user/register", this.register.bind(this));
        application.get("/user/login", this.login.bind(this));
        application.get("/user/update", this.update.bind(this));
        application.get("/user/delete", this.delete.bind(this));
    };
