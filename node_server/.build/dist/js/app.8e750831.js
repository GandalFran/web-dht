"use strict";
(function (e) { function t(t) { for (var a, o, l = t[0], i = t[1], c = t[2], u = 0, f = []; u < l.length; u++)
    o = l[u], Object.prototype.hasOwnProperty.call(n, o) && n[o] && f.push(n[o][0]), n[o] = 0; for (a in i)
    ...
    for (var r = s[t], a = !0, l = 1; l < r.length; l++) {
        var i = r[l];
        0 !== n[i] && (a = !1);
    }
    a && (s.splice(t--, 1), e = o(o.s = r[0]));
} return e; } var a = {}, n = { app: 0 }, s = []; function o(t) { if (a[t])
    return a[t].exports; var r = a[t] = { i: t, l: !1, exports: {} }; return e[t].call(r.exports, r, r.exports, o), r.l = !0, r.exports; } o.m = e, o.c = a, o.d = function (e, t, r) { o.o(e, t) || Object.defineProperty(e, t, { enumerable: !0, get: r }); }, o.r = function (e) { "undefined" !== typeof Symbol && Symbol.toStringTag && Object.defineProperty(e, Symbol.toStringTag, { value: "Module" }), Object.defineProperty(e, "__esModule", { value: !0 }); }, o.t = function (e, t) { if (1 & t && (e = o(e)), 8 & t)
    return e; if (4 & t && "object" === typeof e && e && e.__esModule)
    return e; var r = Object.create(null); if (o.r(r), Object.defineProperty(r, "default", { enumerable: !0, value: e }), 2 & t && "string" != typeof e)
    for (var a in e)
        o.d(r, a, function (t) { return e[t]; }.bind(null, a)); return r; }, o.n = function (e) { var t = e && e.__esModule ? function () { return e["default"]; } : function () { return e; }; return o.d(t, "a", t), t; }, o.o = function (e, t) { return Object.prototype.hasOwnProperty.call(e, t); }, o.p = "/"; var l = window["webpackJsonp"] = window["webpackJsonp"] || [], i = l.push.bind(l); l.push = t, l = l.slice(); for (var c = 0; c < l.length; c++)
    t(l[c]); var d = i; s.push([0, "chunk-vendors"]), r(); })({ 0: function (e, t, r) { e.exports = r("56d7"); }, 1535: function (e, t, r) {
        "use strict";
        ...
        var o = { theme: { themes: { light: { primary: "#e91e63", darkPink: "#6c000a" } } } }, l = new s.a(o), i = function () { var e = this, t = e.$createElement, r = e._self._c || t; return r("div", { attrs: { id: "app" } }, [r("router-view")], 1); }, c = [], d = (r("be3c"), r("2877")), u = {}, f = Object(d["a"])(u, i, c, !1, null, "7ce212f2", null), p = f.exports, v = r("8c4f"), h = function () { var e = this, t = e.$createElement, r = e._self._c || t; return r("div", { staticClass: "dash" }, [r("v-app-bar", { attrs: { fixed: "" } }, [r("v-toolbar", { staticClass: " toolbar hidden-md-and-up", attrs: { dark: "", color: "#d3d3d3", id: "toolbar" } }, [r("v-spacer"), r("v-toolbar-items", [r("v-col", { attrs: { cols: "12", sm: "3" } }, [r("v-btn", { staticClass: "toolbar", attrs: { text: "", color: "#0f1c41", to: "/filesTreatment" } }, [e._v(" Files ")])], 1), r("v-col", { attrs: { cols: "12", sm: "5" } }, [r("v-btn", { staticClass: "toolbar", attrs: { text: "", color: "#0f1c41", to: "/statusDownloadingFiles" } }, [e._v(" Download Status ")])], 1), r("v-col", { attrs: { cols: "12", sm: "3" } }, [r("v-btn", { staticClass: "toolbar", attrs: { text: "", color: "#0f1c41", to: "/statusUploadingFiles" } }, [e._v(" Upload Status ")])], 1)], 1)], 1)], 1), r("router-view")], 1); }, m = [], g = { data: function () { return { items: [{ path: "/#/", title: "Download Status" }, { path: "/#/statusUploadingFiles", title: "Upload Status" }, { path: "/#/filesTreatment", title: "Files" }], locationWindow: null, on: !1 }; }, methods: { onClickMenu: function (e) { window.location.href = e.path; } } }, b = g, x = Object(d["a"])(b, h, m, !1, null, null, null), w = x.exports, _ = function () { var e = this, t = e.$createElement, r = e._self._c || t; return r("div", { attrs: { id: "searchTable" } }, [r("v-container", { attrs: { "grid-list-xl": "", "text-xs-center": "" } }, [r("v-layout", { attrs: { row: "", wrap: "" } }, [r("v-flex", { attrs: { xs12: "" } }, [r("v-file-input", { attrs: { id: "inputFile", type: "file", label: "Click here to select file for upload", outlined: "" }, model: { value: e.file, callback: function (t) { e.file = t; }, expression: "file" } })], 1), r("v-flex", { attrs: { xs12: "" } }, [r("v-btn", { staticClass: "futura", attrs: { id: "okFileButton", text: "", color: "#0f1c41", left: "" }, on: { click: function (t) { return e.onUploadClick(); } } }, [e._v(" Upload File ")])], 1), r("v-flex", { attrs: { xs12: "" } }, [r("v-alert", { attrs: { value: e.fileErrorFlag, "v-bind": e.fileErrorMessage, type: "error" } }, [e._v(" " + e._s(e.fileErrorMessage) + " ")])], 1)], 1)], 1), r("v-container", { attrs: { "grid-list-xl": "", "text-xs-center": "" } }, [r("v-layout", { attrs: { row: "", wrap: "" } }, [r("v-flex", { attrs: { xs12: "" } }, [r("v-file-input", { attrs: { id: "inputTorrent", type: "file", label: "Click here to select torrent for fownload", outlined: "" }, model: { value: e.torrentFile, callback: function (t) { e.torrentFile = t; }, expression: "torrentFile" } })], 1), r("v-flex", { attrs: { xs12: "" } }, [r("v-btn", { staticClass: "futura", attrs: { id: "okFileButton", text: "", color: "#0f1c41", left: "" }, on: { click: function (t) { return e.onDownloadClick(); } } }, [e._v(" Download File ")])], 1), r("v-flex", { attrs: { xs12: "" } }, [r("v-alert", { attrs: { value: e.torrentErrorFlag, "v-bind": e.torrentErrorMessage, type: "error" } }, [e._v(" " + e._s(e.torrentErrorMessage) + " ")])], 1)], 1)], 1)], 1); }, F = [], y = "http://localhost", k = "80", D = { data: function () { return { file: null, fileErrorMessage: null, fileErrorFlag: !1, torrentFile: null, torrentErrorMessage: null, torrentErrorFlag: null }; }, methods: { onDownloadClick: function () { if (this.torrentErrorMessage = null, this.torrentErrorFlag = !1, null == this.torrentFile)
            ...
            } }, methods: { onButtonClick: function (e) { console.log("click on " + e.nombre); var t = new XMLHttpRequest; if (t.open("POST", y + ":" + k + "/download/delete", !1), t.send(JSON.stringify(e.id)), console.log("He enviado petición para eliminar"), 200 == t.status && 1 == t.response) {
                    console.log("He recibido confirmación");
                    var r = this.filesDownloaded.map((function (e) { return e.id; })).indexOf(e.id);
                    this.filesDownloaded.slice(r, 1);
                } }, intervalRetreaving: function () { var e = this.files, t = this.filesDownloaded; setInterval((function () { var r = new XMLHttpRequest; if (r.open("GET", y + ":" + k + "/download/status", !1), r.send(), 200 == r.status) {
                ...
                this.intervalRetreaving();
            } }, methods: { onButtonClick: function (e) { console.log("click on " + e.nombre); var t = new XMLHttpRequest; if (t.open("POST", y + ":" + k + "/upload/delete", !1), t.send(JSON.stringify(e.id)), console.log("He enviado petición para eliminar"), 200 == t.status && 1 == t.response) {
                    console.log("He recibido confirmación");
                    var r = this.filesUploaded.map((function (e) { return e.id; })).indexOf(e.id);
                    this.filesUploaded.slice(r, 1);
                } }, intervalRetreaving: function () { var e = this.files, t = this.filesUploaded; setInterval((function () { var r = new XMLHttpRequest; if (r.open("GET", y + ":" + k + "/upload/status", !1), r.send(), 200 == r.status) {
                    console.log(r.response);
                    var a = r.response;
                    if (a.length > 0)
                        for (var n = 0; n < a.length; n++) {
...
//# sourceMappingURL=app.8e750831.js.map
